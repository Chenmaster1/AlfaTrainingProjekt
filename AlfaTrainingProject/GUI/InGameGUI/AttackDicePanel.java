...
public class AttackDicePanel extends JPanel implements Runnable {
    ...
    // Animationsgeschwindigkeit zentral im GamePanel definiert
     ...
     * übergebene Ergebnis anzeigt. Pausiert den aufrufenden Thread, bis die
     * Animation abgeschlossen ist.
     *
     * @param result Das gewünschte Würfelergebnis
     */
	...
	// AttackDice Animation starten und auf Abschluss warten
	synchronized (this) {
     ...
     * Abständen getestet wird, ob das gezeigte Frame geändert werden muss. Weckt
     * den gameLogicThread auf und beendet, wenn das erwünschte Frame erreicht
     * wurde.
     */
    @Override
    public void run() {
