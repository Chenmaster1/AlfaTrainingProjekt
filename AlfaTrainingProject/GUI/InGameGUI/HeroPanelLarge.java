...
public class HeroPanelLarge extends JPanel {
	 ...
	 * Status der Actions bzw. Abilities etwas ändert.
	 * 
	 * Solange buttonsEnabled false ist, sind werden alle Buttons deaktiviert
	 * (während der Züge anderer Spieler setzen)
	 */
	...
	/**
	 * Untermethode zum Zeichnen der Actionpoint-Icons. Die reale Größe der Icons
	 * wird vor dem Aufruf aus den relativen Konstanten und der Fenstergröße
	 * berechnet und übergeben, weil sie die gleiche ist wie bei den Hitpoint-Icons.
	 *
	 * @param g2d
	 * @param iconSize_X
	 * @param iconSize_Y
	...
	/**
	 * Untermethode zum Zeichnen der Hitpoint-Icons. Die reale Größe der Icons wird
	 * vor dem Aufruf aus den relativen Konstanten und der Fenstergröße berechnet
	 * und übergeben, weil sie die gleiche ist wie bei den Actionpoint-Icons.
	 *
	 * @param g2d
	 * @param iconSize_X
	 * @param iconSize_Y
	 ...
	 * Liste an Buttons für das actionListPanel. Wird immer aufgerufen, wenn eine
	 ...
	 *
	 * Unabhängig von der aktuellen Anzahl der Buttons im actionListPanel liegt der
...
//		abilityDescriptionField.setFont(new Font(abilityDescriptionFieldFont.getName(), Font.PLAIN, newFontSize));
	...
	/**
	 * Setzt eine neue Liste an möglichen Actions und passt die Buttons entsprechend
	 * an. Nur benutzen, wenn die Optionen permanent verändert werden sollen. Soll
	 * eine Aktion vorübergehend (de)aktiviert werden, dann an dieser
