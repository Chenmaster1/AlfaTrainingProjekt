...
public class SingleplayerGame {
     ...
     * Heldenspezifischen Abilities zu einer Liste zusammen und übergibt der GUI
     * die Liste des Hauptsspielers, damit diese in JButtons umgemünzt werden
     * kann.
     *
     * Abilities mit dem AbilityType PASSIVE oder REACTION werden übersprungen,
     * da sie nicht aktiv einsetzbar sind. Ihre Effekte müssen anderweitig
     ...
     * Aktion auswählt. Diese speichern die Wahl als Attribut im
     * SingleplayerGame und benutzen dann notify(), um den gameLogicThread
     * wieder zu wecken (siehe playerTurn()).
     *
     * Ein nach dem gleichen Prinzip funktionierender MouseListener wird für die
     * Zielauswahl initialisiert. Dieser wird bei einer Angriffsaktion des
     * Spielers temporär beim MapPanel angemeldet (siehe setGameState).
     */
    ...
    /**
     * TODO vermutlich sollten die Actions als Control-Objekte ins gleiche
     * Package wie SingleplayerGame und diese Methode auf package protected
     * stehen
     *
     * @param gameState
     */
    ...
    /**
     * Eine einzelne Attacke auf ein anvisiertes Feld. Trifft gemäß der durch
    ...
    /**
     * Startet den Sudden-Death Modus, in dem Helden mehrmals pro Runde
